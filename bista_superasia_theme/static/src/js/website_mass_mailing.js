...
//            self.$('.js_subscribed_btn').toggleClass('d-none', !isSubscriber);
            self.$('.js_subscribe_btn').removeClass('btn-primary');
            self.$('.js_subscribe_btn').addClass('btn custom_them_primary btn-secondary-footer js_subscribe_btn o_default_snippet_text text-white');
        };
