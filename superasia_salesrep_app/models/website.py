...
class Website(models.Model):
    ...
    def sale_get_order(self, force_create=False, code=None, update_pricelist=False, force_pricelist=False):
        """ 
        Modify default sale_get_order for sales rep users.
        """
        sales_rep_user = request.session.get('sales_rep_user', None)
        ...
        self.ensure_one()
        selected_partner_id = request.session.get("selected_partner_id", None)
        if selected_partner_id:
            partner = self.env['res.partner'].browse(int(selected_partner_id))
        else:
